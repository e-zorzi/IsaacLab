...
class GoalPositionCommandCfg(CommandTermCfg):
    ...
    # Set the scale of the visualization markers to (0.2, 0.2, 0.8)
    goal_pose_visualizer_cfg.markers["target_far"].radius = 0.08
    goal_pose_visualizer_cfg.markers["target_near"].radius = 0.08
    goal_pose_visualizer_cfg.markers["target_invisible"].radius = 0.08
